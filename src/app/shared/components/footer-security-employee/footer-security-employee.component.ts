...
@Component({
  selector: 'app-footer-security-employee',
  templateUrl: './footer-security-employee.component.html',
  styleUrls: ['./footer-security-employee.component.scss']
})
export class FooterSecurityEmployeeComponent implements OnInit {
