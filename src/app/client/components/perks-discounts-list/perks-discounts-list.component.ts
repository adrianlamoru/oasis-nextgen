...
@Component({
  selector: 'app-perks-discounts-list',
  templateUrl: './perks-discounts-list.component.html',
  styleUrls: ['./perks-discounts-list.component.scss']
})
export class PerksDiscountsListComponent implements OnInit {
