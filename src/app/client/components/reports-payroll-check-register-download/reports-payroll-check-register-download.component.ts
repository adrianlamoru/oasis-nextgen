...
@Component({
  selector: 'app-reports-payroll-check-register-download',
  templateUrl: './reports-payroll-check-register-download.component.html',
  styleUrls: ['./reports-payroll-check-register-download.component.scss']
})
export class ReportsPayrollCheckRegisterDownloadComponent implements OnInit {
  ...
  selectedDownloadOption(item) {
    ...
    this.fileService.downloadFileByUrl('/assets/csv/CheckRegister.csv', 'Check Register Download');
  }
